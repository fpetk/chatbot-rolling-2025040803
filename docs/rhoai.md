...
3) Access the `workbench` named `chatbot-rolling-2025040803-notebook`.
...
5) In the terminal, run `cd chatbot-rolling-2025040803` to navigate to your sample app's directory.
